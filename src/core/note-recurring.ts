...
export class NoteRecurrence {
  ...
  private static getNextWeekdayOccurrence(
    ...
    let nextWeekday = weekdayNumbers.find(day => day > currentWeekday);
   ...
   */
  private static isDateInRange(date: ICalendarDate, start: ICalendarDate, end: ICalendarDate): boolean {
